        ...
        return (
            <div className="bg-lightBlue min-h-full py-10">
                <div className="text-center">
                    <h2 className="pt-5 lg:text-4xl md:text-3xl font-bold mb-4">
                        <span role="img" aria-label="graduation cap">🎓</span> My Education
                    </h2>
                    <p className="text-gray-600 mb-10 lg:text-[14px] md:text-xs">
                ...
                <div className="lg:max-w-6xl mx-auto">
                    <div data-aos="fade-up"
                         ...
                         className="md:ml-10 md:mr-10 bg-white shadow-md rounded-lg flex flex-col md:flex-row items-center mb-8 hover:shadow-lg">
                        <img
                            src={Bolton}
                        ...
                        <div className="p-6 w-full">
                            <h3 className="lg:text-2xl md:text-xl font-bold text-blue-900">Bcs (Hons). in Computer Science</h3>
                    ...
                    <div data-aos="fade-up"
                         data-aos-anchor-placement="top-bottom"
                         className="md:ml-10 md:mr-10 bg-white shadow-md rounded-lg flex flex-col md:flex-row items-center hover:shadow-lg">
                        <img
                            src={IJSE}
                        ...
                        />
                        <div className="p-6 w-full">
                            <h3 className="lg:text-2xl md:text-xl font-bold text-blue-900">Graduate Diploma in Software Engineering - GDSE</h3>
